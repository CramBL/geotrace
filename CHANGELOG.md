...
- The log viewer filters as you type, in plain terms or a regular expression, and "+ Add filter" keeps the filter as a coloured chip marking the lines it matches.
