...
- Environment archives created by older versions are rebuilt when they are opened, so deleting days from them frees space the days downloaded afterwards are written into.
