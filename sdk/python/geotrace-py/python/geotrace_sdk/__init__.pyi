...
from .enums import Constellation as Constellation
from .enums import MarkerIcon as MarkerIcon
from .enums import TravelMode as TravelMode
...
class Meta:
    ...
    @property
    def sdk_git_commit(self) -> str | None: ...
    @property
    def sdk_commit_time(self) -> datetime | None:
        """Committer timestamp of :attr:`sdk_git_commit` (timezone-aware UTC)."""
        ...
