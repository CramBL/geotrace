...
| **chronological run** | A maximal stretch of a sensor channel's samples whose timestamps never step backwards. No line crosses a backward step: the plot draws one line per run. | `Channel::chronological_runs`, `ChannelComponentSeries::runs` |
