...
[group("ci")]
ci-essentials: fmt-check-all clippy-all check-all test examples qa::qa-lint qa::test qa::check-all qa::check-versions qa::check-app doc check-bindings check-c-header osv-scanner sort-check shear typos qa::vale-added qa::check-function-imports-added qa::check-inline-modules-added qa::check-commit-length
