...
mod tests {
    ...
    fn snap_action_enablement_per_state_and_offline(
    ...
    fn snap_action_offline_hover_names_the_blocking_condition(
        #[case] row: SnapRowView,
        #[case] expected_substring: &str,
    ) {
        let action = snap_action(&row, view(Offline(true), ConsentPending(false))).map(|a| a.hover);
    ...
    fn snap_action_consent_suffix_only_on_clickable_states(
        #[case] row: SnapRowView,
        #[case] expected: bool,
    ) {
