...
pub use fixtures::{
    ...
    nav_points_from, nav_points_walking_from, nav_points_with_a_latitude_out_of_range,
    nav_points_without_a_valid_position, nav_test_data, single_nav_point, stationary_nav_data,
    synthetic_gtd_bytes, synthetic_gtd_bytes_with_channels, track_geometry,
};
#[cfg(feature = "snapshot")]
