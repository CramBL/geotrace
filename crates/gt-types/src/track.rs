...
mod tests {
    ...
    #[test]
    fn travel_mode_from_wire_round_trips_every_variant() {
    ...
    #[test]
    fn travel_mode_display_names_are_stable() {
        let known = [
            (TravelMode::Car, "Car"),
            (TravelMode::Motorcycle, "Motorcycle"),
            (TravelMode::Bicycle, "Bicycle"),
    ...
    fn time_range_spanning_covers_every_instant(
        #[case] first_hour: u32,
        #[case] rest_hours: &[u32],
    ...
    fn time_range_union_covers_both_ranges(
    ...
    fn time_range_intersection_is_the_shared_span(
    ...
    fn resolves_the_nearest_satellite_report(
    ...
    #[test]
    fn nearest_satellite_report_of_an_out_of_bounds_index_is_none() {
