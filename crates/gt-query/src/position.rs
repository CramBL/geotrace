...
mod tests {
    ...
    #[test]
    fn source_completion_waits_for_a_typed_character() {
    ...
    #[test]
    fn completion_offers_stage_keywords_after_a_typed_character() {
    ...
    #[test]
    fn completion_fuzzy_filters_a_partial_stage_keyword() {
    ...
    #[test]
    fn completion_offers_metrics_and_functions_after_a_typed_character() {
    ...
    #[test]
    fn completion_offers_only_matching_units_after_a_number() {
    ...
    #[test]
    fn completion_offers_duration_units_after_delta_of_time() {
    ...
    #[test]
    fn completion_joins_nothing_to_a_finished_unit() {
    ...
    #[test]
    fn completion_offers_the_params_in_with() {
    ...
    #[test]
    fn completion_offers_the_columns_in_table() {
    ...
    #[test]
    fn completion_offers_values_inside_a_column_aggregate() {
    ...
    #[test]
    fn completion_offers_nothing_after_display_modes() {
        assert!(names("points | draw ").is_empty());
    }

    #[test]
    fn completion_offers_duration_units_after_a_window_count() {
    ...
    proptest! {
        ...
        #[test]
        fn editor_assistance_never_panics(src in ".*", cursor in 0usize..256) {
