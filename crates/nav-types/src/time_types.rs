...
//! # Public surface
//!
//! These types are internal to the workspace (not re-exported by `naview-sdk`).
//! The `naview-sdk` public API continues to accept and return plain
//! `DateTime<Utc>` values; conversions happen at the `nav-io` boundary.
//!
