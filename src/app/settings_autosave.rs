...
pub(super) struct AppSnapshot {
    ...
    pub sky_trail_opacity_percent: StableF32,
    ...
    pub clock_excursion_threshold_s: StableF32,
...
impl Default for AppSnapshot {
    fn default() -> Self {
        ...
        Self {
            ...
            sky_trail_opacity_percent: StableF32::from(gt_sky::TRAIL_OPACITY_PERCENT_DEFAULT),
            ...
            detect_clock_offset_excursions: processing.detect_clock_offset_excursions,
            ...
            mark_backward_time_steps: analysis.mark_backward_time_steps,
            snr_drop_db: StableF32::from(analysis.snr_drop_db),
            slip_window_min: StableF32::from(analysis.slip_window_min),
            clock_excursion_threshold_s: StableF32::from(analysis.clock_excursion_threshold_s),
